...
export default function ReservationScreen() {
  ...
  return (
    <View style={styles.container}>
      <Image source={require('../assets/rec.jpeg')} style={{ marginBottom: 20 }}></Image>
      <Text style={{ fontWeight: 'bold', marginBottom: 10, fontSize: 18 }}>Detalhes</Text>
      ...
      <Text style={{ fontWeight: 'bold', marginBottom: 5 }}>Data de Entrada</Text>
      <TextInput
        style={styles.input}
